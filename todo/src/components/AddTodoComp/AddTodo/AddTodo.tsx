...
This function prevents default behavior page refresh on 
form submit and sets error to state if length of characters 
either less than 5 or greater than 50. 

Else if there'r no errors than it dispatches action to the 
reducer to add new task with unique id. And sets input to empty ""
...
*/
  ...
  /**
 This function removes error from the state if character length 
 is greater than 5 and less than 50
